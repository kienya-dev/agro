(() => {
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector("[data-catalog-slider]")) new core("[data-catalog-slider]", {
                modules: [ Navigation ],
                slidesPerView: 2,
                spaceBetween: 24,
                autoHeight: true,
        ...
        if (menuToggles.length) {
            const toggleMenu = (toggler, classButton, classMenu) => {
                ...
                const navList = classButton === "button_contact_active" ? boxMenu.querySelector(".header__menu-contact") : boxMenu.querySelector(".nav__list");
                ...
                if (catalogNav && toggler.classList.contains("catalog-nav__button")) catalogNav.classList.toggle("catalog-nav_active");
                ...
                links.forEach((link => link.addEventListener("click", (() => {
                    ...
                    if (!parent.classList.contains("header__item_down") && !parent.classList.contains("drop-down__item")) {
                        ...
                        if (icon) icon.classList.remove("catalog-nav__icon_active");
                        if (catalogNav) catalogNav.classList.remove("catalog-nav_active");
                    }
                }))));
            ...
            addEventListener() {
                this._el.addEventListener("click", (e => {
                    ...
                    if (!this._config.alwaysOpen) {
                        ...
                        if (elOpenItem) elOpenItem !== elHeader.parentElement ? this.toggle(elOpenItem) : null;
                    }
        ...
        if (accordion) new Accordion(accordion, {
            alwaysOpen: false
        });
        const dropLinks = document.querySelectorAll(".header__link");
        if (dropLinks.length) dropLinks.forEach((link => {
            const nextElement = link.nextElementSibling;
            if (nextElement && nextElement.classList.contains("drop-down")) link.addEventListener("click", (e => {
                e.preventDefault();
                link.closest(".header__list");
